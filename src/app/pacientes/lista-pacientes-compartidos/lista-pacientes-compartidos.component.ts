...
import { PageImpl, PageRequest, PageRequestCanalizado } from 'src/app/core/models/shared/page.models';

@Component({
  selector: 'app-lista-pacientes-compartidos',
  templateUrl: './lista-pacientes-compartidos.component.html',
  styleUrl: './lista-pacientes-compartidos.component.scss'
})
export class ListaPacientesCompartidosComponent implements OnInit  {
  @ViewChild('txtBuscar') txtBuscar!: ElementRef;

  pacientes: PatientPageView[] = [];
  paginado: PageImpl<PatientPageView> = new PageImpl();
  pageRequest: PageRequestCanalizado = new PageRequestCanalizado();
  ...
  buscarPacientes(): void {
    ...
    this.pacienteService.getPageCanalizado(this.pageRequest).subscribe({
      next: (res) => {
        this.paginado = res;
