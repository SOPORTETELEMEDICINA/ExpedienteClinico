...
import { PageImpl , PageRequest } from '../../core/models/shared/page.models';
import { PatientView, PatientPageView } from '../../core/models/pacientes/paciente.model';
...
export class ListaPacientesComponent implements OnInit  {
  ...
  buscarPacientes(): void {
    ...
    this.pacienteService.getPage(this.pageRequest).subscribe({
      next: (res) => {
        this.paginado = res;
