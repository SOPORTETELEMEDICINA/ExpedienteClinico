...
// NUEVOS MENUS
  public static get doctorsList(): string {
    return this.baseUrl + '/medicos/lista';
  }
  public static get addDoctor(): string {
    return this.baseUrl + '/medicos/agregar';
  }
  ...
  public static get editPatient(): string {
    return this.baseUrl + '/pacientes/editar'; // Este lo usarás para el botón de editar con id dinámico
  }
